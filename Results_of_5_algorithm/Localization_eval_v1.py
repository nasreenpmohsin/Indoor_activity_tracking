'''
Evaluation
Technique 1: Least Squares Optimization in Multilateration
Author: Nasreen Mohsin
WDW_SIZE=[3,6,9,12,15,18]
USAGE= python Localization_eval_v5.py TX WDW_SIZE offline read_data.txt Position_no. sv save_file.txt
       python Localization_eval_v5.py TX WDW_SIZE online IP_addr Port  sv save_file.txt
Eg: python SFU_Localization_eval_v5.py -8 6 offline data_eval_pos2.txt 2  sv eval_v5_pos2.txt
'''
    ...
    if new_time-old_time >wndw:
        ...
        if fs_cnt >2:
            ...
            mini = lmfit.Minimizer(
                ...
                fcn_args=(FS_pos, d)  # Additional parameters for se
                )

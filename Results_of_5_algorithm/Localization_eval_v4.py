'''
Version 5
To evaluate Nearest point in region belonging to Fixed Scanner recording highest signal strength in a given window
Technique4 : offline clustering scheme
Author: Nasreen Mohsin
WDW_SIZE=[3,6,9,12,15,18]
USAGE= python Localization_eval_v4.py TX WDW_SIZE offline read_data.txt Position_no. sv save_file.txt
       python Localization_eval_v4.py TX WDW_SIZE online IP_addr Port  sv save_file.txt
Eg: python SFU_Localization_eval_v4.py -8 5 offline data_eval_pos2.txt 2  sv eval_v5_pos2.txt
'''
    ...
    if new_time-old_time >wndw:
        ...
        if fs_cnt>0:
            if fs_cnt==1:
                ...
                #CI=[[d[max_i]+d_ci[max_i],d[max_i]]-d_ci[max_i],[d[max_i]+d_ci[max_i],d[max_i]-d_ci[max_i]]]
                CI = [[d[max_i] - d_ci[max_i], d[max_i] + d_ci[max_i]], [d[max_i] ,d_ci[max_i]]]
